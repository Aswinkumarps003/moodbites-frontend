...
const API_URL = "https://food-service-new.onrender.com/api/food/dishes"; // Change this to your actual backend endpoint
const CLOUDINARY_UPLOAD_URL = "https://food-service-new.onrender.com/api/food/upload-recipe-image"; // Food service Cloudinary upload endpoint
